    ...
    <center>
      ...
      <div align="center">
        ...
        <div align="center">
            ...
            <form:form
              action="addShippingChoice"
              method="post"
              modelAttribute="shippingChoice"
            >
    
              <form:label path="shippingCarrier">Shipping Carrier:</form:label>
              <form:select path="shippingCarrier" items="${shippingCarrierList}" /><br />
    
              <form:label path="shippingType">Shipping Type:</form:label>
              <form:select path="shippingType" items="${shippingTypeList}" /><br />
     
              <form:button>Add Shipping Choice</form:button>
            </form:form>
          </div>
